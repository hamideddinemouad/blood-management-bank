...
const AboutUs = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-red-50 to-white">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-r from-red-600 to-red-700 py-16 text-white sm:py-20">
        <div className="absolute inset-0 bg-black/20"></div>
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="mb-6 text-3xl font-bold sm:text-5xl md:text-6xl">
            Saving Lives, One Drop at a Time
          </h1>
          <p className="mx-auto mb-8 max-w-3xl text-base opacity-90 sm:text-xl md:text-2xl">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg">
              <h3 className="mb-6 text-2xl font-bold text-gray-900 sm:text-3xl">Our Vision</h3>
              <p className="text-lg text-gray-700 mb-6">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="mb-4 text-3xl font-bold text-gray-900 sm:text-4xl">Our Values</h2>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="mb-4 text-3xl font-bold text-gray-900 sm:text-4xl">Meet Our Team</h2>
            <p className="mx-auto max-w-2xl text-base text-gray-600 sm:text-xl">
      ...
      <section className="py-20 bg-gradient-to-r from-red-600 to-red-700 text-white">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          <h2 className="mb-6 text-3xl font-bold sm:text-4xl">Ready to Make a Difference?</h2>
