...
const DashboardLayout = ({ userRole = "donor" }) => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-red-50 to-white">
      {/* HEADER */}
      <header
        className={`flex justify-between items-center bg-white/95 backdrop-blur-md shadow-sm border-b border-red-100 px-4 sm:px-6 py-3 sticky top-0 z-[70] transition-all duration-300 ${
      ...
      >
        ...
        <div className="flex items-center gap-2 sm:gap-4">
          <button
            ...
            className="hidden md:inline-flex items-center gap-2 rounded-xl border border-red-200 bg-white px-3 py-2 text-sm font-medium text-red-700 shadow-sm transition-all duration-200 hover:border-red-300 hover:bg-red-50"
            title="Back to demo setup"
          >
            <ArrowLeft size={16} />
            Demo setup
          </button>
