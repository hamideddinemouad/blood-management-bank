...
const LabProfile = () => {
    ...
    switch (path) {
      ...
      case "emergencyContact":
        if (value && !isValidMoroccanPhone(value)) {
          newErrors[path] = MOROCCAN_PHONE_HINT;
        } else {
  ...
  const handleChange = (e) => {
    ...
    const nextValue =
      name === "phone" || name === "emergencyContact"
        ? sanitizeMoroccanPhoneInput(value)
        : value;
    ...
    if (name.startsWith("address.")) {
      ...
      setFormData((prev) => {
        const updatedData = {
          ...prev,
          address: { ...prev.address, [key]: nextValue },
        };
      ...
      setFormData((prev) => {
        const updatedData = {
          ...prev,
          operatingHours: { ...prev.operatingHours, [key]: nextValue },
        };
      ...
      setFormData((prev) => {
        const updatedData = { ...prev, [name]: nextValue };
        validateField(name, nextValue);
        return updatedData;
      });
    }
  ...
  const handleSave = async () => {
    ...
    const payload = {
      ...formData,
      phone: normalizeMoroccanPhone(formData.phone),
      emergencyContact: normalizeMoroccanPhone(formData.emergencyContact),
    };
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-red-100 p-6 mb-6">
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-800 sm:text-3xl break-words">
