...
export default function Login() {
  ...
  return (
    <div className="min-h-[calc(100vh-10rem)] flex items-center justify-center bg-gray-50 px-4 py-10">
      <div className="bg-white shadow-xl rounded-xl p-8 w-full max-w-md border border-gray-200">
        ...
        <div className="mt-6">
          <DemoAccessPanel
            title="Demo login"
            description="Skip manual entry and jump straight into demo role accounts with auto-refreshed sample data."
            variant="compact"
          />
        </div>
